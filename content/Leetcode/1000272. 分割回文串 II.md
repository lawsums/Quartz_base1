---
Date: 2026-01-31
Link: https://leetcode.com/problems/omKAoA/
Category: 
- 字符串
- 动态规划
Difficulty: Hard
...
type link
action file:///E%3A%5CDocuments%5CObsidian_%5CCpp%5CLeetcode%5C1000272.%20%E5%88%86%E5%89%B2%E5%9B%9E%E6%96%87%E4%B8%B2%20II.cpp
```
```button
...
注意：本题与主站 132 题相同： [https://leetcode.cn/problems/palindrome-partitioning-ii/](https://leetcode.cn/problems/palindrome-partitioning-ii/)

## Notes
重点:
1. 预计算降低时间复杂度, 同时预计算的流程很有趣
2. F(i) 的定义也很重要->前i个字符中最少分割几次能够分成全是回文串
...
public:
    int minCut(string s) {
        ...
        for (int i = n - 1; i >= 0; --i) { // TODO 为什么i倒着来遍历
            for (int j = i + 1; j < n; ++j) {
